...
sio.print_text(sio.make_float_readable(12))
sio.print_text(sio.make_float_readable('123.4'))
sio.print_text(sio.make_float_readable(1234.5))
sio.print_text(sio.make_float_readable(12345))
sio.print_text(sio.make_float_readable(123456))
sio.print_text(sio.make_float_readable(1234567))
sio.print_newline(3)

sio.print_title('make_int_readable Examples')
sio.print_text(sio.make_int_readable(1))
sio.print_text(sio.make_int_readable(12))
sio.print_text(sio.make_int_readable('123'))
sio.print_text(sio.make_int_readable(1234.0))
sio.print_text(sio.make_int_readable(12345))
sio.print_text(sio.make_int_readable(123456))
sio.print_text(sio.make_int_readable(1234567))
sio.print_newline(3)
